        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.itemTitle}> Confirma la eliminacion de '{props.category.category_name}'  </Text>
              <View style={styles.modalContainer}>
                <TouchableOpacity
                  style={styles.modalButton}
                  onPress={() => {
                    props.handleDelete(props.category.project_id, props.category.id)
                    setModalShow(!modalShow)
                  }}
                >
